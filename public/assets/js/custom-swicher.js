...
function switcherEvents() {
    ...
    $(document).on("click", '#myonoffswitch1', function () {
        if (this.checked) {
            ...
            localStorage.removeItem('vistacolormenu');
            localStorage.removeItem('vistagradientmenu');
            localStorage.removeItem('vistadarkmenu');
            localStorage.removeItem('vistacolorheader');
            localStorage.removeItem('vistagradientheader');
            localStorage.removeItem('vistadarkheader');
            ...
            localStorage.removeItem("vistalight-mode");
        }
        localStorageBackup();
    });
    // LIGHT THEME END
    ...
    $(document).on("click", '#myonoffswitch2', function () {
        if (this.checked) {
            ...
            localStorage.removeItem('vistacolormenu');
            localStorage.removeItem('vistagradientmenu');
            localStorage.removeItem('vistalightmenu');
            localStorage.removeItem('vistacolorheader');
            localStorage.removeItem('vistagradientheader');
            localStorage.removeItem('vistalightheader');
            ...
            $('body').removeClass('dark-mode');
            localStorage.removeItem("vistadark-mode");
        }
        localStorageBackup()
    });
    // DARK THEME END
    ...
    $(document).on("click", '#myonoffswitchTransparent', function () {
        if (this.checked) {
            ...
            $('body').removeClass('transparent-mode');
            localStorage.removeItem("vistatransparent-mode");
        }
        localStorageBackup()
    ...
    $(document).on("click", '#myonoffswitch24', function () {
        if (this.checked) {
            ...
            (document.getElementById("style").setAttribute("href", "../assets/css/plugins/bootstrap/css/bootstrap.rtl.min.html"));
    ...
    $(document).on("click", '#myonoffswitch34', function () {
        if (this.checked) {
            ...
            localStorage.setItem("vistavertical", true);
            localStorage.removeItem("vistahorizontal");
            localStorage.removeItem("vistahorizontalHover");
            localStorage.removeItem("vistaclosedmenu");
            localStorage.removeItem("vistaicontextmenu");
            localStorage.removeItem("vistasideiconmenu");
            localStorage.removeItem("vistahoversubmenu");
            localStorage.removeItem("vistahoversubmenu1");
            localStorage.removeItem("vistadoublemenu");
            localStorage.removeItem("vistadoublemenutabs");
            localStorage.removeItem("vistadefaultlogo");
            localStorage.removeItem("vistacenterlogo");
            responsive();
            ...
            localStorage.setItem("vistasidebar-mini", "False");
        }
    });
    // Vertical END
    ...
    $(document).on("click", '#myonoffswitch35', function () {
        if (this.checked) {
            ...
            $('#slide-left').removeClass('d-none');
            $('#slide-right').removeClass('d-none');
            localStorage.setItem("vistahorizontal", true);
            localStorage.removeItem("vistavertical");
            localStorage.removeItem("vistahorizontalHover");
            localStorage.removeItem("vistadefaultmenu");
            localStorage.removeItem("vistaclosedmenu");
            localStorage.removeItem("vistaicontextmenu");
            localStorage.removeItem("vistasideiconmenu");
            localStorage.removeItem("vistahoversubmenu");
    ...
    $(document).on("click", '#myonoffswitch111', function () {
        if (this.checked) {
            ...
            localStorage.setItem("vistahorizontalHover", true);
            localStorage.removeItem("vistavertical");
            localStorage.removeItem("vistahorizontal");
            localStorage.removeItem("vistadefaultmenu");
            localStorage.removeItem("vistaclosedmenu");
    ...
    $(document).on("click", '#myonoffswitch13', function () {
        if (this.checked) {
            ...
            $('body').removeClass('center-logo');
            $('body').removeClass('default-logo');
            localStorage.setItem("vistadefaultmenu", true);
            localStorage.removeItem("vistaclosedmenu");
            localStorage.removeItem("vistaicontextmenu");
            localStorage.removeItem("vistasideiconmenu");
            localStorage.removeItem("vistahoversubmenu");
    ...
    $(document).on("click", '#myonoffswitch15', function () {
        if (this.checked) {
            ...
            $('body').removeClass('center-logo');
            $('body').removeClass('default-logo');
            localStorage.setItem("vistasideiconmenu", true);
            localStorage.removeItem("vistadefaultmenu");
            localStorage.removeItem("vistaicontextmenu");
            localStorage.removeItem("vistaclosedmenu");
            localStorage.removeItem("vistahoversubmenu");
    ...
    $(document).on("click", '#myonoffswitch14', function () {
        if (this.checked) {
            ...
            $('body').removeClass('center-logo');
            $('body').removeClass('default-logo');
            localStorage.setItem("vistaicontextmenu", true);
            localStorage.removeItem("vistadefaultmenu");
            localStorage.removeItem("vistaclosedmenu");
            localStorage.removeItem("vistasideiconmenu");
            localStorage.removeItem("vistahoversubmenu");
    ...
    $(document).on("click", '#myonoffswitch16', function () {
        if (this.checked) {
            ...
            $('body').removeClass('center-logo');
            $('body').removeClass('default-logo');
            localStorage.setItem("vistaclosedmenu", true);
            localStorage.removeItem("vistadefaultmenu");
            localStorage.removeItem("vistaicontextmenu");
            localStorage.removeItem("vistasideiconmenu");
            localStorage.removeItem("vistahoversubmenu");
    ...
    $(document).on("click", '#myonoffswitch17', function () {
        if (this.checked) {
            ...
            $('body').removeClass('center-logo');
            $('body').removeClass('default-logo');
            localStorage.setItem("vistahoversubmenu", true);
            localStorage.removeItem("vistadefaultmenu");
            localStorage.removeItem("vistaicontextmenu");
            localStorage.removeItem("vistasideiconmenu");
            localStorage.removeItem("vistaclosedmenu");
    ...
    $(document).on("click", '#myonoffswitch18', function () {
        if (this.checked) {
            ...
            $('body').removeClass('center-logo');
            $('body').removeClass('default-logo');
            localStorage.setItem("vistahoversubmenu1", true);
            localStorage.removeItem("vistadefaultmenu");
            localStorage.removeItem("vistaicontextmenu");
            localStorage.removeItem("vistasideiconmenu");
            localStorage.removeItem("vistaclosedmenu");
    ...
    $(document).on("click", '#doublemenu-switch', function () {
        if (this.checked) {
            ...
            $('body').removeClass('center-logo');
            $('body').removeClass('default-logo');
            localStorage.setItem("vistadoublemenu", true);
            localStorage.removeItem("vistadefaultmenu");
            localStorage.removeItem("vistaicontextmenu");
            localStorage.removeItem("vistasideiconmenu");
            localStorage.removeItem("vistaclosedmenu");
    ...
    $(document).on("click", '#doublemenu-switch1', function () {
        if (this.checked) {
            ...
            $('body').removeClass('center-logo');
            $('body').removeClass('default-logo');
            localStorage.setItem("vistadoublemenutabs", true);
            localStorage.removeItem("vistadefaultmenu");
            localStorage.removeItem("vistaicontextmenu");
            localStorage.removeItem("vistasideiconmenu");
            localStorage.removeItem("vistaclosedmenu");
    ...
    $(document).on("click", '#default-logo', function () {
        if (this.checked) {
            ...
            $('body').removeClass('center-logo');
            localStorage.setItem("vistadefaultlogo", true);
            localStorage.removeItem("vistacenterlogo");
        }
    });
    //  Default Logo End
    ...
    $(document).on("click", '#center-logo', function () {
        if (this.checked) {
            ...
            $('body').removeClass('default-logo');
            localStorage.setItem("vistacenterlogo", true);
            localStorage.removeItem("vistadefaultlogo");
        }
    });
    //  Center Logo End
    ...
    $(document).on("click", '#myonoffswitch3', function () {
        if (this.checked) {
            ...
            $('body').removeClass('dark-menu');
            $('body').removeClass('gradient-menu');
            localStorage.setItem("vistalightmenu", true);
            localStorage.removeItem("vistacolormenu");
            localStorage.removeItem("vistadarkmenu");
            localStorage.removeItem("vistagradientmenu");
        } else {
    ...
    $(document).on("click", '#myonoffswitch4', function () {
        if (this.checked) {
            ...
            $('body').removeClass('dark-menu');
            $('body').removeClass('gradient-menu');
            localStorage.setItem("vistacolormenu", true);
            localStorage.removeItem("vistalightmenu");
            localStorage.removeItem("vistadarkmenu");
            localStorage.removeItem("vistagradientmenu");
        } else {
    ...
    $(document).on("click", '#myonoffswitch5', function () {
        if (this.checked) {
            ...
            $('body').removeClass('light-menu');
            $('body').removeClass('gradient-menu');
            localStorage.setItem("vistadarkmenu", true);
            localStorage.removeItem("vistalightmenu");
            localStorage.removeItem("vistacolormenu");
            localStorage.removeItem("vistagradientmenu");
        } else {
    ...
    $(document).on("click", '#myonoffswitch19', function () {
        if (this.checked) {
            ...
            $('body').removeClass('light-menu');
            $('body').removeClass('dark-menu');
            localStorage.setItem("vistagradientmenu", true);
            localStorage.removeItem("vistalightmenu");
            localStorage.removeItem("vistacolormenu");
            localStorage.removeItem("vistadarkmenu");
        } else {
    ...
    $(document).on("click", '#myonoffswitch6', function () {
        if (this.checked) {
            ...
            $('body').removeClass('dark-header');
            $('body').removeClass('gradient-header');
            localStorage.setItem("vistalightheader", true);
            localStorage.removeItem("vistacolorheader");
            localStorage.removeItem("vistadarkheader");
            localStorage.removeItem("vistagradientheader");
        } else {
    ...
    $(document).on("click", '#myonoffswitch7', function () {
        if (this.checked) {
            ...
            $('body').removeClass('dark-header');
            $('body').removeClass('gradient-header');
            localStorage.setItem("vistacolorheader", true);
            localStorage.removeItem("vistalightheader");
            localStorage.removeItem("vistadarkheader");
            localStorage.removeItem("vistagradientheader");
        } else {
    ...
    $(document).on("click", '#myonoffswitch8', function () {
        if (this.checked) {
            ...
            $('body').removeClass('header-light');
            $('body').removeClass('gradient-header');
            localStorage.setItem("vistadarkheader", true);
            localStorage.removeItem("vistalightheader");
            localStorage.removeItem("vistacolorheader");
            localStorage.removeItem("vistagradientheader");
        } else {
    ...
    $(document).on("click", '#myonoffswitch20', function () {
        if (this.checked) {
            ...
            $('body').removeClass('header-light');
            $('body').removeClass('dark-header');
            localStorage.setItem("vistagradientheader", true);
            localStorage.removeItem("vistalightheader");
            localStorage.removeItem("vistacolorheader");
            localStorage.removeItem("vistadarkheader");
        } else {
    ...
    $(document).on("click", '#myonoffswitch9', function () {
        if (this.checked) {
            ...
            localStorage.setItem("vistafullwidth", true);
            localStorage.removeItem("vistaboxedwidth");
            checkHoriMenu();
        } else {
    ...
    $(document).on("click", '#myonoffswitch10', function () {
        if (this.checked) {
            ...
            $('body').removeClass('layout-fullwidth');
            localStorage.setItem("vistaboxedwidth", true);
            localStorage.removeItem("vistafullwidth");
            checkHoriMenu();
        } else {
            $('body').removeClass('layout-boxed');
        }
    ...
    $(document).on("click", '#myonoffswitch11', function () {
        if (this.checked) {
            ...
            localStorage.setItem("vistafixed", true);
            localStorage.removeItem("vistascrollable");
        } else {
    ...
    $(document).on("click", '#myonoffswitch12', function () {
        if (this.checked) {
            ...
            $('body').removeClass('fixed-layout');
            localStorage.setItem("vistascrollable", true);
            localStorage.removeItem("vistafixed");
        } else {
            $('body').removeClass('scrollable-layout');
        }
    });
